...
export class NamespacedDataStore {
  ...
  private getAITools(): ToolSet {
   ...
   public async readResource( params: z.infer<typeof ReadResourceRequestSchema>["params"],
  ...
  public async getPrompt( { name, ...params }: z.infer<typeof GetPromptRequestSchema>["params"], 
   ...
   public async complete( { ref, ...params }: z.infer<typeof CompleteRequestSchema>["params"],
  ...
  public async callTool( { name, ...params }: z.infer<typeof CallToolRequestSchema>["params"],
